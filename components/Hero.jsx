...
const Hero = () => {
  return (
    <div className="w-full flex bg-gradient-to-b from-blue-50 via-blue-100 to-blue-200 justify-center">
      <div className="w-full px-3 lg:px-0 lg:w-3/5 h-[300px] lg:h-[400px] flex">
        <div className="w-1/2 items-center flex">
          <div className="flex flex-col gap-1">
            <div className="text-xs lg:text-sm text-neutral-950 text-opacity-50">
            ...
            <div className="text-xs lg:text-sm text-neutral-950 text-opacity-50">
              ...
              quaerat quisquam accusamus molestias maiores
            </div>
