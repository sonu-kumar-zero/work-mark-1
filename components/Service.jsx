...
const Service = () => {
  return (
    <div className="w-full flex justify-center bg-blue-50">
      <div className="w-full px-3 lg:px-0 lg:w-3/5 flex flex-col items-center gap-5 py-10 lg:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 w-full gap-10 lg:gap-5 mt-10">
          <ServicePalate />
          <ServicePalate />
          <ServicePalate />
        </div>
